...
### 운용의 용이성 평가 기준 2.1 충분한 시간(enough time)
...
> 참고
> 이 성공기준은 사용자가 콘텐츠나 맥락에서 시간 제한에 의해 나타나는 예상치 못한 변동 사항없이 과없을 완료할 수 있도록 보장한다. 이 성공기준은 사용자 행동의 콘텐츠나 맥락의 변경을 일으키는 것에 대한 제한 기준인 성공기준 3.2.1 포컷흐 시와 함께 고려되어야 한다.
